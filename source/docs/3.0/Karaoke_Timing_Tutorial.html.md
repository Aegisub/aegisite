...
[[!template id=Todo text="a bit about styles, how basic karaoke looks, and the \kf and \ko effects"]]


## Wrapping up  ##


[[!template id=Todo text="mention the video tutorial again and point to other relevant topics"]]
