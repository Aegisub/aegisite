...
function importScript(page) {
	var uri = wgScript + '?title=' +
		encodeURIComponent(page.replace(/ /g,'_')).replace('%2F','../index.html').replace('%3A',':') +
...
var ts_image_up = "sort_up.html";
var ts_image_down = "sort_down.html";
var ts_image_none = "sort_none.html";
